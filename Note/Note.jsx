...
3. <form className="" onSubmit={handler} method=""></form>
   ...
   - <form method="dialog"> + <button type="submit"> -> dialog.close()
...
8. <input type="" id="" value={} checked={true}/{false} onChange={} placeholder=""/>
   - input: input field
   ...
   - placeholder="": is the grey hint text shown when the input is empty; it’s not the actual input value.

9. <button onClick={handleClick}></button>
   - default type="submit"
   - type="button": makes it a normal button that won’t submit the form.
...
25. component
    ...
    - e.g. function App( ) {...}
    - Server Component: runs on the server → produces HTML, Pure display/data render
    - Client Component: runs in the browser → supports interaction
